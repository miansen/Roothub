...
/**
 * 该类是基础响应码枚举类，定义了通用的系统级响应码枚举。
 *
 * @author miansen.wang
 * @date 2020-01-20
 * @since 3.0
 */
public enum BaseResultCodeEnum implements BaseResultCode {
	 ...
	 */
	INAPPROPRIATE_JSON(400, "InappropriateJSON", "The JSON you provided was well-formed and valid, but not appropriate for this operation."),
     ...
     * 非法参数
     */
    ILLEGAL_ARGUMENT(400, "IllegalArgument", "Illegal parameter.");

	/**
	 * http 响应码，可以通过调用 {@code response.setStatus()} 设置服务器响应的 {@code Status Code}。
	 */
	private final int httpCode;

	/**
	 * 服务器响应码，可以通过 json 或者页面的形式返回给客户端，以便客户端能够清楚发生错误的原因。
	 */
	private final String code;

	/**
	 * 服务器响应的详细信息，可以通过 json 或者页面的形式返回给客户端，以便客户端能够清楚发生错误的详细信息。
	 */
     ...
     * @param code 服务器响应码
     * @param message 服务器响应的详细信息
     */
	BaseResultCodeEnum(int httpCode, String code, String message) {
