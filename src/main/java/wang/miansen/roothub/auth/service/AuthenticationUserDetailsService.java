 ...
 * 加载用户数据的 Service 接口。
 * <p>
 * 它在整个框架中用作用户 DAO，是 {@link DaoAuthenticationProvider} 使用的策略。
 * </p>
...
public interface AuthenticationUserDetailsService extends UserDetailsService {
     ...
     * @return 完整的用户信息（非空）
     * @throws AuthenticationMobileNotFoundException 如果找不到用户或者用户没有授予的权限，则抛出此异常。
     */
    UserDetails loadUserByMobile(String mobile) throws AuthenticationMobileNotFoundException;
}
