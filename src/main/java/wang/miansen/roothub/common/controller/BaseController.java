...
public interface BaseController<VO extends BaseVO> {
	 ...
	 * @return Result
	 */
	Result<VO> remove(Integer id, HttpServletRequest request, HttpServletResponse response);
	 ...
	 * @return
	 */
	Result<VO> update(Integer id, VO vo, HttpServletRequest request, HttpServletResponse response);
	 ...
	 * @return Result
	 */
	Result<VO> getOne(Integer id, HttpServletRequest request, HttpServletResponse response);
	 ...
	 * @return Result
	 */
	Result<Page<? extends VO>> page(Integer pageNumber, HttpServletRequest request, HttpServletResponse response);
