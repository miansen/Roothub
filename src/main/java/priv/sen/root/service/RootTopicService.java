...
public interface RootTopicService {
	 ...
	 * @return
	 */
	PageDataBody<RootTopic> page(Integer pageNumber, Integer pageSize, String tab);
	 ...
	 * @return
	 */
	PageDataBody<RootTopic> pageAll(Integer pageNumber, Integer pageSize);
	 ...
	 * @return
	 */
	PageDataBody<RootTopic> pageAllNewest(Integer pageNumber, Integer pageSize);
	
	/**
	 * 分页查询精华话题
	 */
	PageDataBody<RootTopic> pageGood(Integer pageNumber, Integer pageSize);
	 ...
	 * @return
	 */
	PageDataBody<RootTopic> pageNoReply(Integer pageNumber, Integer pageSize);
