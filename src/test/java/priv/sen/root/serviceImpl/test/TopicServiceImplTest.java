...
public class TopicServiceImplTest extends BaseTest{
	...
	public void pageTest() throws Exception{
		PageDataBody<Topic> page = rootTopicService.pageByNodeAndNodeTab(1, 20, "all","all");
	...
	public void pageByAuthor() throws Exception{
		PageDataBody<Topic> page = rootTopicService.pageByAuthor(1, 20, "public");
		Result<PageDataBody<Topic>> result = new Result<>(true, page);
	...
	public void findAllTest() throws Exception{
		List<Topic> findAll = rootTopicService.findAll();
	...
	public void findById() throws Exception{
		Topic findByTopicId = rootTopicService.findByTopicId(30);
	...
	public void pageByTagTest() throws Exception{
		PageDataBody<Topic> pageByTag = rootTopicService.pageByTag("delete", 1, 20);
	...
	public void pageLikeTest() throws Exception{
		PageDataBody<Topic> pageLike = rootTopicService.pageLike(1, 20, "测试");
	...
	public void pageAllByAuthorTest() throws Exception{
		PageDataBody<Topic> page = rootTopicService.pageAllByPtabAndAuthor(1, 20, "qna", "Tyche");
	...
	public void test01() throws Exception{
		...
		List<Topic> rows = CollUtil.newArrayList(row1);
