...
<body>
	<div class="container">
		...
		<p style="color: #778087;">去<a href="https://github.com/miansen" target="_blank">鼓励</a>我并获取<a href="https://github.com/miansen/roothub" target="_blank">源码</a>，你的<svg class="octicon octicon-star v-align-text-bottom" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74L14 6z"></path></svg>Star将是我源源不断的动力</p>
		...
		<p style="color: #ccc;">♥ Believe in yourself</p>
		...
		<!-- <p>
			<span id="busuanzi_container_site_pv" style="display: inline;">本站总访问量<span
				id="busuanzi_value_site_pv">6675</span>次
			</span> | <span id="busuanzi_container_page_pv" style="display: inline;">本文总阅读量<span
				id="busuanzi_value_page_pv">193</span>次
			</span> | <span id="busuanzi_container_site_uv" style="display: inline;">本站总访客数<span
				id="busuanzi_value_site_uv">863</span>次
			</span>
		</p> -->
	</div>
</body>
