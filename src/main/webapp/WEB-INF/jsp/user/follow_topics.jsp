		...
		<div class="row">
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="/">Roothub</a> / ${user.userName}关注的话题</div>
					<div class="panel-body paginate-bot">

						<c:forEach var="item" items="${page.list}">
							<div class="media" id="topic">
								<div class="media-left">
									<a href="/user/${item.author}"><img
										src="/resources/images/${item.avatar}"
										class="avatar img-circle" alt=""></a>
								</div>
								<div class="media-body">
									...
									<p class="gray">
										...
										<span class="hidden-sm hidden-xs">•</span> <span
											class="hidden-sm hidden-xs"><a href="/topic/41">${item.replyCount}个评论</a></span>
										<span class="hidden-sm hidden-xs">•</span> <span
											class="hidden-sm hidden-xs">${item.viewCount}次浏览</span> <span>•</span>
